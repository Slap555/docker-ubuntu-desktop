...
\n\
    # WebSocket del VNC (Tunel interno)\n\
    location /websockify {\n\
...
\n\
# IMPORTANTE: Moverse al directorio base de PufferPanel para que encuentre emails.json y el frontend\n\
cd /usr/share/pufferpanel || cd /var/lib/pufferpanel || cd /\n\
...
# 6. Solo exponemos el puerto principal de Railway
EXPOSE 80
